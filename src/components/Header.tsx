...
import { Float } from "./AnimatedSection";
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <Float delay={0}>
            <div className="absolute top-[10%] left-[5%] w-64 h-64 rounded-full opacity-[0.07]" style={{ background: "hsl(var(--sand))" }} />
          </Float>
          <Float delay={1.5}>
            <div className="absolute bottom-[15%] right-[8%] w-48 h-48 rounded-full opacity-[0.05]" style={{ background: "hsl(var(--sand))" }} />
          </Float>
          <Float delay={2.5}>
            <div className="absolute top-[40%] right-[20%] w-32 h-32 rounded-full opacity-[0.04]" style={{ background: "white" }} />
          </Float>
        </div>
        ...
        <div className="container-site relative z-10">
          <div className="flex items-center justify-between gap-5 py-5 flex-wrap">
            <motion.a
              ...
              aria-label="Greystone College Home"
          ...
          <AnimatePresence>
            {mobileOpen && (
              <motion.div
                className="lg:hidden rounded-2xl p-3 mb-4 flex flex-col gap-0.5"
